...
ColorPicker Widget
-------------------------------------------------------------------------------]]
local Type, Version = "ColorPicker", 9999
...
local function ColorSwatch_OnClick(frame, button)
	ColorPickerFrame:Hide()
	local self = frame.obj
	if not self.disabled then
		if button == "RightButton" then
			local option = self:GetUserData("option")
			if option and option.arg and option.arg.default then
				local default = option.arg.default
				local r = default.r or default[1]
				local g = default.g or default[2]
				local b = default.b or default[3]
				local a = default.a or default[4] or 1
				self:SetColor(r, g, b, a)
				self:Fire("OnValueChanged", r, g, b, a)
				self:Fire("OnValueConfirmed", r, g, b, a)
			end
